...
-- ============================================
-- DATOS DEMO (solo ambiente de pruebas)
-- Ventas, pagos y turnos de ejemplo para probar la app.
-- ============================================
-- orders (22 filas)
INSERT INTO `orders` (`id`, `status`, `table_id`, `customer_name`, `mode`, `notes`, `subtotal`, `tax`, `total`, `created_by`, `parked_at`, `voided_at`, `voided_by`, `created_at`, `updated_at`) VALUES
  (1, 'pagada', 1, 'Oscar Paz', 'mesa', NULL, 53, 0, 53, 1, '2026-09-20 16:59:36', NULL, NULL, '2026-09-20 16:59:36', '2026-09-20 23:34:46'),
  (2, 'anulada', 3, 'Elisa', 'mesa', NULL, 58, 6.96, 64.96, 1, '2026-09-20 17:00:05', '2026-09-20 17:00:28', 1, '2026-09-20 17:00:05', '2026-09-20 17:00:28'),
  (3, 'anulada', 1, 'Test', 'mesa', 'notes', 55, 6.6, 61.6, 1, '2026-09-20 22:30:20', '2026-09-22 10:47:43', 1, '2026-09-20 22:30:20', '2026-09-22 10:47:43'),
  (10, 'pagada', 4, 'Maria', 'mesa', NULL, 53, 6.36, 59.36, 1, '2026-09-21 10:30:46', NULL, NULL, '2026-09-21 10:30:46', '2026-09-21 10:30:54'),
  (13, 'pagada', 3, 'María', 'mesa', NULL, 67, 0, 67, 1, '2026-09-21 12:25:03', NULL, NULL, '2026-09-21 12:25:03', '2026-09-21 12:25:20'),
  (14, 'pagada', 6, 'Ester', 'mesa', NULL, 57, 6.84, 63.84, 1, '2026-09-21 12:26:21', NULL, NULL, '2026-09-21 12:26:21', '2026-09-21 12:26:26'),
  (16, 'pagada', 3, 'Roberto', 'mesa', NULL, 28, 0, 28, 1, '2026-09-21 13:43:51', NULL, NULL, '2026-09-21 13:43:51', '2026-09-21 13:44:01'),
  (17, 'pagada', 5, 'Juan', 'mesa', NULL, 26, 0, 26, 1, '2026-09-21 14:48:49', NULL, NULL, '2026-09-21 14:48:49', '2026-09-21 14:48:54'),
  (18, 'pagada', 3, 'Maria', 'mesa', NULL, 30, 0, 30, 1, '2026-09-21 14:49:53', NULL, NULL, '2026-09-21 14:49:53', '2026-09-21 14:50:00'),
  (19, 'pagada', 7, 'Mainor', 'mesa', NULL, 25, 0, 25, 1, '2026-09-21 15:02:34', NULL, NULL, '2026-09-21 15:02:34', '2026-09-21 15:02:44'),
  (20, 'pagada', 4, 'Regina', 'mesa', NULL, 55, 0, 55, 1, '2026-09-21 15:04:17', NULL, NULL, '2026-09-21 15:04:17', '2026-09-21 15:04:27'),
  (21, 'pagada', NULL, 'Test Inventario', 'mesa', NULL, 74, 0, 74, NULL, NULL, NULL, NULL, '2026-09-21 22:08:29', '2026-09-21 22:08:41'),
  (24, 'pagada', 4, 'Alma', 'mesa', NULL, 25, 3, 28, 1, '2026-09-21 22:44:49', NULL, NULL, '2026-09-21 22:44:49', '2026-09-21 22:45:00'),
  (25, 'anulada', 2, 'Miranda', 'mesa', NULL, 93, 11.16, 104.16, 1, '2026-09-21 23:44:35', '2026-09-21 23:44:50', 1, '2026-09-21 23:44:35', '2026-09-21 23:44:50'),
  (26, 'pagada', 5, 'Maria', 'mesa', NULL, 26, 0, 26, 1, '2026-09-22 00:56:40', NULL, NULL, '2026-09-22 00:56:40', '2026-09-22 00:57:37'),
  (27, 'pagada', 2, 'Elias', 'mesa', NULL, 53, 0, 53, 1, '2026-09-22 00:59:09', NULL, NULL, '2026-09-22 00:59:09', '2026-09-22 00:59:37'),
  (28, 'pagada', 3, 'Marina', 'mesa', NULL, 25, 0, 25, 1, '2026-09-22 10:45:00', NULL, NULL, '2026-09-22 10:45:00', '2026-09-22 10:45:07'),
  (29, 'pagada', 5, 'Marta', 'mesa', NULL, 25, 0, 25, 1, '2026-09-22 10:46:27', NULL, NULL, '2026-09-22 10:46:27', '2026-09-22 10:46:36'),
  (30, 'pagada', 5, 'Armando', 'mesa', NULL, 25, 0, 25, 1, '2026-09-22 10:47:58', NULL, NULL, '2026-09-22 10:47:58', '2026-09-22 10:48:03'),
  (31, 'pagada', NULL, 'QA Print Test', 'llevar', NULL, 35, 0, 35, 1, '2026-09-22 11:06:57', NULL, NULL, '2026-09-22 11:06:57', '2026-09-22 11:06:57'),
  (32, 'pagada', NULL, 'Mariana', 'mesa', NULL, 58, 0, 58, 1, '2026-09-22 11:13:45', NULL, NULL, '2026-09-22 11:13:45', '2026-09-22 11:13:52'),
  (33, 'pausada', 4, 'Capitan', 'mesa', NULL, 28, 3.36, 31.36, 1, '2026-09-22 11:14:29', NULL, NULL, '2026-09-22 11:14:29', '2026-09-22 11:14:29');

-- order_items (31 filas)
INSERT INTO `order_items` (`id`, `order_id`, `product_id`, `quantity`, `unit_price`, `modifiers`, `modifier_labels`, `notes`, `created_at`) VALUES
  (1, 1, 21, 1, 25, '[]', NULL, NULL, '2026-09-20 16:59:36'),
  (2, 1, 1, 1, 28, '[]', NULL, NULL, '2026-09-20 16:59:36'),
  (3, 2, 14, 1, 58, '[]', NULL, NULL, '2026-09-20 17:00:05'),
  (10, 10, 1, 1, 28, '[]', NULL, NULL, '2026-09-21 10:30:46'),
  (11, 10, 3, 1, 25, '[]', NULL, NULL, '2026-09-21 10:30:46'),
  (12, 13, 8, 1, 32, '[]', NULL, NULL, '2026-09-21 12:25:03'),
  (13, 13, 10, 1, 35, '[]', NULL, NULL, '2026-09-21 12:25:03'),
  (14, 14, 10, 1, 35, '[]', NULL, NULL, '2026-09-21 12:26:21'),
  (15, 14, 16, 1, 22, '[]', NULL, NULL, '2026-09-21 12:26:21'),
  (16, 16, 9, 1, 28, '[]', NULL, NULL, '2026-09-21 13:43:51'),
  (17, 17, 2, 1, 26, '[]', NULL, NULL, '2026-09-21 14:48:49'),
  (18, 18, 6, 1, 30, '[]', NULL, NULL, '2026-09-21 14:49:53'),
  (19, 19, 3, 1, 25, '[]', NULL, NULL, '2026-09-21 15:02:34'),
  (20, 20, 20, 1, 55, '[]', NULL, NULL, '2026-09-21 15:04:17'),
  (21, 21, 1, 2, 28, NULL, NULL, NULL, '2026-09-21 22:08:29'),
  (22, 21, 4, 1, 18, NULL, NULL, NULL, '2026-09-21 22:08:29'),
  (25, 24, 21, 1, 25, '[]', NULL, NULL, '2026-09-21 22:44:49'),
  (26, 3, 4, 1, 20, '[]', NULL, NULL, '2026-09-21 23:44:18'),
  (27, 3, 10, 1, 35, '[]', NULL, NULL, '2026-09-21 23:44:18'),
  (28, 25, 2, 1, 26, '[]', NULL, NULL, '2026-09-21 23:44:35'),
  (29, 25, 16, 1, 22, '[]', NULL, NULL, '2026-09-21 23:44:35'),
  (30, 25, 17, 1, 45, '[]', NULL, NULL, '2026-09-21 23:44:35'),
  (31, 26, 2, 1, 26, '[]', NULL, NULL, '2026-09-22 00:56:40'),
  (32, 27, 9, 1, 28, '[]', NULL, NULL, '2026-09-22 00:59:09'),
  (33, 27, 15, 1, 25, '[]', NULL, NULL, '2026-09-22 00:59:09'),
  (34, 28, 3, 1, 25, '[]', NULL, NULL, '2026-09-22 10:45:00'),
  (35, 29, 3, 1, 25, '[]', NULL, NULL, '2026-09-22 10:46:27'),
  (36, 30, 21, 1, 25, '[]', NULL, NULL, '2026-09-22 10:47:58'),
  (37, 31, 10, 1, 35, NULL, NULL, NULL, '2026-09-22 11:06:57'),
  (38, 32, 14, 1, 58, '[]', NULL, NULL, '2026-09-22 11:13:45'),
  (39, 33, 9, 1, 28, '[]', NULL, NULL, '2026-09-22 11:14:29');

-- payments (18 filas)
INSERT INTO `payments` (`id`, `order_id`, `method`, `amount`, `amount_given`, `change_amount`, `cashier_id`, `sat_invoice`, `created_at`) VALUES
  (7, 1, 'efectivo', 53, 100, 47, 1, NULL, '2026-09-20 23:34:46'),
  (8, 10, 'tarjeta', 59.36, NULL, 0, 1, NULL, '2026-09-21 10:30:54'),
  (11, 13, 'efectivo', 67, 100, 33, 1, NULL, '2026-09-21 12:25:20'),
  (12, 14, 'tarjeta', 63.84, NULL, 0, 1, NULL, '2026-09-21 12:26:26'),
  (14, 16, 'efectivo', 28, 28, 0, 1, NULL, '2026-09-21 13:44:01'),
  (15, 17, 'efectivo', 26, 26, 0, 1, NULL, '2026-09-21 14:48:54'),
  (16, 18, 'efectivo', 30, 30, 0, 1, NULL, '2026-09-21 14:50:00'),
  (17, 19, 'efectivo', 25, 25, 0, 1, NULL, '2026-09-21 15:02:44'),
  (18, 20, 'efectivo', 55, 55, 0, 1, NULL, '2026-09-21 15:04:27'),
  (19, 21, 'efectivo', 74, 100, 26, 1, NULL, '2026-09-21 22:08:41'),
  (22, 24, 'efectivo', 28, 50, 22, 1, NULL, '2026-09-21 22:45:00'),
  (23, 26, 'efectivo', 26, 100, 74, 1, NULL, '2026-09-22 00:57:37'),
  (24, 27, 'efectivo', 53, 70, 17, 1, NULL, '2026-09-22 00:59:37'),
  (25, 28, 'efectivo', 25, 28, 3, 1, NULL, '2026-09-22 10:45:07'),
  (26, 29, 'efectivo', 25, 28, 3, 1, NULL, '2026-09-22 10:46:36'),
  (27, 30, 'efectivo', 25, 28, 3, 1, NULL, '2026-09-22 10:48:03'),
  (28, 31, 'efectivo', 35, 35, 0, 1, NULL, '2026-09-22 11:06:57'),
  (29, 32, 'efectivo', 58, 60, 2, 1, NULL, '2026-09-22 11:13:52');

-- shifts (3 filas)
INSERT INTO `shifts` (`id`, `cashier_id`, `station`, `start_time`, `close_time`, `start_cash`, `actual_cash`, `expected_cash`, `difference`, `status`, `total_sales`, `cash_sales`, `card_sales`, `qr_sales`, `transaction_count`) VALUES
  (1, 1, 'Estacion 01', '2026-09-21 10:11:57', '2026-09-21 11:48:44', 400, 400, 400, 0, 'closed', 59.36, 0, 59.36, 0, 1),
  (3, 1, 'Estacion 01', '2026-09-21 12:25:45', '2026-09-22 00:20:11', 200, 494, 494, 0, 'closed', 357.84, 294, 63.84, 0, 9),
  (4, 1, 'Estacion 01', '2026-09-22 00:57:06', NULL, 400, NULL, NULL, NULL, 'open', 0, 0, 0, 0, 0);

-- shift_transactions (17 filas)
INSERT INTO `shift_transactions` (`id`, `shift_id`, `order_id`, `type`, `method`, `amount`, `created_at`) VALUES
  (1, 1, 10, 'sale', 'tarjeta', 59.36, '2026-09-21 10:30:54'),
  (5, 3, 14, 'sale', 'tarjeta', 63.84, '2026-09-21 12:26:26'),
  (7, 3, 16, 'sale', 'efectivo', 28, '2026-09-21 13:44:01'),
  (8, 3, 17, 'sale', 'efectivo', 26, '2026-09-21 14:48:54'),
  (9, 3, 18, 'sale', 'efectivo', 30, '2026-09-21 14:50:00'),
  (10, 3, 19, 'sale', 'efectivo', 25, '2026-09-21 15:02:44'),
  (11, 3, 20, 'sale', 'efectivo', 55, '2026-09-21 15:04:27'),
  (12, 3, 21, 'sale', 'efectivo', 74, '2026-09-21 22:08:41'),
  (13, 3, NULL, 'sale', 'efectivo', 28, '2026-09-21 22:08:52'),
  (15, 3, 24, 'sale', 'efectivo', 28, '2026-09-21 22:45:00'),
  (16, 4, 26, 'sale', 'efectivo', 26, '2026-09-22 00:57:37'),
  (17, 4, 27, 'sale', 'efectivo', 53, '2026-09-22 00:59:37'),
  (18, 4, 28, 'sale', 'efectivo', 25, '2026-09-22 10:45:07'),
  (19, 4, 29, 'sale', 'efectivo', 25, '2026-09-22 10:46:36'),
  (20, 4, 30, 'sale', 'efectivo', 25, '2026-09-22 10:48:03'),
  (21, 4, 31, 'sale', 'efectivo', 35, '2026-09-22 11:06:57'),
  (22, 4, 32, 'sale', 'efectivo', 58, '2026-09-22 11:13:52');

-- purchase_orders (1 filas)
INSERT INTO `purchase_orders` (`id`, `supplier_id`, `status`, `total`, `notes`, `created_by`, `received_at`, `created_at`) VALUES
  (1, 1, 'received', 580, 'Test PO', 1, '2026-09-21 22:59:23', '2026-09-21 22:57:25');

-- purchase_order_items (2 filas)
INSERT INTO `purchase_order_items` (`id`, `po_id`, `inventory_id`, `quantity`, `unit_cost`) VALUES
  (1, 1, 7, 10, 42),
  (2, 1, 8, 20, 8);
